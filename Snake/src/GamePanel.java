...
public class GamePanel extends JPanel implements ActionListener {
    ...
    public void startGame() {
        ...
        // Center position aligned to grid
        int centerX = (SCREEN_WIDTH / 2) / UNIT_SIZE * UNIT_SIZE;
        int centerY = (SCREEN_HEIGHT / 2) / UNIT_SIZE * UNIT_SIZE;

        x[0] = centerX;
        y[0] = centerY;

        // Initialize body behind head
    ...
    public void draw(Graphics g){
        if(running){
            /*
            int cols = (SCREEN_WIDTH + UNIT_SIZE - 1) / UNIT_SIZE;
            int rows = (SCREEN_HEIGHT + UNIT_SIZE - 1) / UNIT_SIZE;
    ...
    public void gameOver(Graphics g){
        ...
        g.drawString(
                scoreText,
                (SCREEN_WIDTH - metrics2.stringWidth(scoreText)) / 2,
                g.getFont().getSize()
        );
    }
    @Override
